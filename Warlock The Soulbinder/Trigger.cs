...
namespace Warlock_The_Soulbinder
{
    public class Trigger
    {
        ...
        public Trigger(Vector2 position, Rectangle collisionBox, string targetZone, string targetName)
        {
        ...
        public Trigger(string name, Vector2 position, Rectangle collisionBox, string zoneName, bool exit)
        {
            Name = name;
            Position = position;
            CollisionBox = collisionBox;
