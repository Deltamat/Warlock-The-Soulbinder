                ...
                case "Armor":
                    switch (index)
                    {
                        case 0: //sheep
                            ...
                            break;
                        case 1: //wolf
                            EffectString = "Has a chance to give you\nmore damage after being hit";
                        ...
                        case 11: //banshee
                            ...
                            break;
                        case 12: //bucket man
                            EffectString = "Has a chance to give yourself \na shield after being hit";
                            if (GameWorld.Instance.RandomInt(0, 7) == 0)
                            {
                                TargetsSelf = true;
                                Shield = (int)(3 * ((stone.Level + GameWorld.Instance.RandomInt(1, 3)) * 0.3f));
